...
thargstar_1 = np.array([
    ...
    [547.625, -316.0625, -1506.8125],   # Col 69 Sector KB-W c2-0
    [530.8125, -290.21875, -1471.59375],# Col 69 Sector LM-U c3-1
    [532.8125, -287.90625, -1422.21875],# HD 38659
    [526.625, -283.15625, -1376.21875], # Orion Dark Region CB-X c1-1
    [509.4375, -277.34375, -1335.78125],# Orion Dark Region CL-Y d17
])
...
thargstar_2 = np.array([
    ...
    [-1780.65625, -592.21875, -2365.21875], # Slegi CC-B d14-4
    [-1762.46875, -581.84375, -2319.875],   # Oochoss LL-D c1
])
...
thargstar_3 = np.array([
    ...
    [-375.28125, -177.4375, -1838.03125],   # Oochost IC-S d5-4
    [-365.59375, -182.46875, -1752.40625],  # Oochost AO-L b27-0
    [-354.5, -181.34375, -1687.28125],      # Oochost NG-G b30-0
])
